...
class MirAnnotation(pychipseq.genomic.Annotation):
    """
    Loads a mir database.
    """

    def __init__(self, refseq_genes:pychipseq.genes.RefSeqGenes, mir_max_gap:int, bin_size:int):
