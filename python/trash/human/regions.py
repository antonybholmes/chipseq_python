...
class GeneOrientatedRegionIntersections(pychipseq.human.genes.GeneOrientatedPeaks):
  """
...
class ClosestGeneOrientatedRegionIntersections(pychipseq.human.genes.GeneOrientatedPeaks):
  def __init__(self):
...
class GeneOrientatedRegionCores(pychipseq.human.genes.GeneOrientatedPeaks):
  """
