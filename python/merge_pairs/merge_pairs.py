...
import sys
import argparse
sys.path.append('/ifs/scratch/cancer/Lab_RDF/ngs/scripts/python/')
import libdna
import libbam
import re
...
def merge(bam, out='', max_len=1000, samtools=SAMTOOLS, dna_dir=DNA_DIR):
    read_map = {} #'collections.defaultdict(pysam.AlignedSegment)

    sam = libbam.SamReader(bam, samtools=samtools)
...
if __name__ == "__main__":
    ...
    merge(args.file[0], out=args.out, max_len=args.max_len, samtools=args.samtools)
