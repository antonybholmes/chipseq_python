...
def load_mir_exp(file, genes_map, type):
  ...
  for line in f:
    ...
    genes_map[lib.annotation.get_mir_id(tokens[0])] = type
...
class MirExpression(object):
  def __init__(self):  
    self.expression_map = collections.defaultdict(str)
    self.previous_ids = lib.annotation.MirPreviousIds()
  
  def get_expression(self, id):
    s = lib.annotation.get_mir_id(id)
...
class AffyGeneCTRLvsSIExpression(Expression):
  ...
  def __init__(self):
    super(AffyGeneCTRLvsSIExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/bcl6_silencing/")
...
class AffyGeneCBvsMExpression(GeneExpression):
  ...
  def __init__(self):
    ...
    super(AffyGeneCBvsMExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/cb_vs_m_20160608/")
...
class AffyGeneCBvsNExpression(GeneExpression):
  ...
  def __init__(self):
    ...
    super(AffyGeneCBvsNExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/cb_vs_n_20160608/")
...
class AffyGeneDZvsLZExpression(GeneExpression):
  ...
  """
  def __init__(self):
    super(AffyGeneDZvsLZExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/dz_vs_lz_20160720/")
...
class RnaSeqGeneSUD10D83vsStopExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneSUD10D83vsStopExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_sud10_d83v_vs_stop_20160610/")


class RnaSeqGeneSUD10WTvsD83vExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneSUD10WTvsD83vExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_sud10_wt_vs_d83v_20160610/")
 

class RnaSeqGeneSUD10WTvsStopExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneSUD10WTvsStopExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_sud10_wt_vs_stop_20160610/")
...
class RnaSeqGeneSUD10D83vsStopDeSeq2Expression(GeneExpression):
  ...
  """
  def __init__(self):
    super(RnaSeqGeneSUD10D83vsStopDeSeq2Expression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_sud10_d83v_vs_stop_deseq2_20160411/")


class RnaSeqGeneSUD10WTvsD83vDeSeq2Expression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneSUD10WTvsD83vDeSeq2Expression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_sud10_wt_vs_d83v_deseq2_20160411/")
 

class RnaSeqGeneSUD10WTvsStopDeSeq2Expression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneSUD10WTvsStopDeSeq2Expression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_sud10_wt_vs_stop_deseq2_20160411/")


class RnaSeqGeneCBvsMExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneCBvsMExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_cb_vs_m_20160610/")
 
    
class RnaSeqGeneCBvsNExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneCBvsNExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_cb_vs_n_20160610/")
  
      
class RnaSeqGeneCBvsMDeSeq2Expression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneCBvsMDeSeq2Expression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_cb_vs_m_deseq2_20160411/")


class RnaSeqGeneCBvsNDeSeq2Expression(GeneExpression):
  def __init__(self):
    super(RnaSeqGeneCBvsNDeSeq2Expression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/rna_seq_cb_vs_n_deseq2_20160411/")
...
class RnaSeqTPMCBvsNExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqTPMCBvsNExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/tpm_cb_vs_n/")
 
class RnaSeqTPMCBvsMExpression(GeneExpression):
  def __init__(self):
    super(RnaSeqTPMCBvsMExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/tpm_cb_vs_m/")
...
class GEPMEF2BMouseWTvsKOExpression(GeneExpression):
  ...
  """
  def __init__(self):
    super(GEPMEF2BMouseWTvsKOExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references_mouse_mef2b_wt_vs_ko_20160606/")
...
class DzLzGeneExpression(Expression):
  ...
  def __init__(self):
    super(DzLzGeneExpression, self).__init__("/ifs/scratch/cancer/Lab_RDF/ngs/chip_seq/references/dark_zone_vs_light_zone/")
