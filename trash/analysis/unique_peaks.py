...
sys.stderr.write(name_1 + " only vs overlap\t" + str(t[1]) + "\n")

t = stats.ttest_ind(data[3], data[2], equal_var = False)
sys.stderr.write(name_2 + " vs overlap\t" + str(t[1]) + "\n")

t = stats.ttest_ind(data[4], data[2], equal_var = False)
sys.stderr.write(name_2 + " only vs overlap\t" + str(t[1]) + "\n")

t = stats.ttest_ind(data[0], data[3], equal_var = False)
sys.stderr.write(name_1 + " vs " + name_2 + "\t" + str(t[1]) + "\n")

t = stats.ttest_ind(data[1], data[4], equal_var = False)
sys.stderr.write(name_1 + " only vs " + name_2 + " only\t" + str(t[1]) + "\n")
