...
def create_bed(file, name, genome):
  ...
  print(lib.bed.create_bedgraph_header(name)) #"track type=bedGraph name=\"" + name  + "\" description=\"" + name + " peaks\" visibility=full autoScale=on alwaysZero=on color=255,0,0\n")
  ...
  for line in f:
    ...
    #lib.bed.write_bedgraph_line(chr, start, end, rpm)
