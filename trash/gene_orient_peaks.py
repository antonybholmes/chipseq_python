...
gene_orientation = lib.human.genes.GeneOrientatedPeaks("Peak")

# Add some custom annotations

# RNA-seq tpm  
#gene_orientation.add_expression("RNA-seq GCvsN TPM", lib.expression.RnaSeqTPMCBvsNExpression())
#gene_orientation.add_expression("RNA-seq GCvsM TPM", lib.expression.RnaSeqTPMCBvsMExpression())
...
# Deseq2 test stuff
#gene_orientation.add_expression("RNA-seq SUD10 WTvsD83V DeSeq2", lib.expression.RnaSeqGeneSUD10WTvsD83vDeSeq2Expression())
#gene_orientation.add_expression("RNA-seq SUD10 WTvsSTOP DeSeq2", lib.expression.RnaSeqGeneSUD10WTvsStopDeSeq2Expression())
#gene_orientation.add_expression("RNA-seq SUD10 D83VvsSTOP DeSeq2", lib.expression.RnaSeqGeneSUD10D83vsStopDeSeq2Expression())
